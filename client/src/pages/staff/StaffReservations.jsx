...
<div className="flex gap-2">
  ...
  <button
    ...
    className="flex items-center gap-1.5 px-3 py-2.5 rounded-lg border bg-white border-gray-300 text-gray-600 flex-shrink-0"
  >
...
{/* Filter chips — always visible by default, toggleable */}
<AnimatePresence>
  {showFilters && (
    <motion.div
